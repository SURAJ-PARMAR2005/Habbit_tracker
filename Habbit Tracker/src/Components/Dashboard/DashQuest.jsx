  ...
  return (
    <div className="flex flex-col gap-6 text-white px-6">
      ...
      <div className="flex md:flex-row flex-col   gap-6 flex-1">
        ...
        {/* cards three */}
        <div className={`physical-training flex flex-col flex-1 w-full border ${physical?"border-2 border-red-600 shadow-xl shadow-red-600":"border"} border-red-500/20 mb-3 p-6 gap-9 rounded-xl shadow-xl shadow-red-400/30`}>
          {/* card1 */}
        ...
        <div className={`Knowledge-acuisition flex flex-col flex-1 w-full border ${Knowledge?"border-2 border-green-600 shadow-2xl shadow-green-600":"border"} border-green-500/20 mb-3 p-6 gap-9 rounded-xl shadow-xl shadow-green-400/30`}>
          {/* card1 */}
          <div className="flex gap-4 items-center justify-between p-3">
            <div className="flex gap-2">
        ...
        <div className={`spritual-acuisition flex flex-col flex-1 w-full shadow-xl ${Spiritual?"border-2 border-purple-600 shadow-2xl shadow-purple-600":"border"} shadow-purple-400/30 border border-purple-500/20 mb-3 p-6 gap-9 rounded-xl`}>
          {/* card1 */}
          <div className="flex gap-4 items-center justify-between p-3">
            <div className="flex gap-2">
              {/* <Dumbbell className="w-5 h-5 text-red-400" />
