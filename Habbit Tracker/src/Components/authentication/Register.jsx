...
const Register = () => {
    const {isRegistered,setIsRegistered,setIsLogin} = usePlayer();
  return (
                ...
                <div className='w-full p-8 gap-8 flex flex-col rounded items-center h-full border-[#00F2FF] border'>
                    ...
                    <form action="submit" className='flex flex-col gap-3'>
                        <div className='flex flex-col items-start gap-1 justify-items-start'>
                            ...
                            <input type="text" placeholder='ENTER_NAME' className='text-[#00f2ff86] px-3 py-2 border  rounded border[#00F2FF]'  />
                        </div>

                         <div className='flex flex-col items-start gap-1 justify-items-start'>
                            <h4 className='text-[#00F2FF] text-sm'>EMAIL ADDRESS</h4>
                            <input type="email" placeholder='ENTER_NAME' className='text-[#00f2ff86] px-3 py-2 border  rounded border[#00F2FF]'  />
                        </div>

                         <div className='flex flex-col items-start gap-1 justify-items-start'>
                            <h4 className='text-[#00F2FF] text-sm'>SECURITY_KEY</h4>
                            <input type="password" placeholder='SECURITY_KEY' className='text-[#00f2ff86] px-3 py-2 rounded bg-transparent border border-[#00F2FF]'  />
                        </div>

                         <div className='flex flex-col items-start gap-1 justify-items-start'>
                            <h4 className='text-[#00F2FF] text-sm'>VERIFY KEY</h4>
                            <input type="password" placeholder='VERIFY_KEY' className='text-[#00f2ff86] px-3 py-2 border rounded  border-[#00F2FF] bg-transparent'  />
                        </div>
